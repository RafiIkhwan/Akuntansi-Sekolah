...
<div class="absolute">
    <div class="modal fade" id="transaksiHapus-{{ $transaksi->id_transaksi }}" tabindex="-1" aria-labelledby="Label" aria-hidden="true">
                ...
                <div class="modal-body">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>: {{ $transaksi->where('bulan', $transaksi->bulan )->sum('total_bayar') }}</td>
                        </tr>
                        <tr>
