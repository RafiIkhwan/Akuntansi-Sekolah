                ...
                <form action="{{ route('pembayaranUpdate') }}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input class="" type="hidden" name="idsiswa" id="idsiswa" value="{{ $transaksi->siswa->id_siswa }}" readonly>
                            ...
                            <input class="form-control" type="text" name="nsiswa" id="nsiswa" value="{{ $transaksi->siswa->nama_siswa }}" readonly>       
                        </div>
                        ...
                        <div class="form-group mt-1">
                            ...
                            <input class="form-control" type="number" name="totalbayar" id="totalbayar" value="{{ $transaksi->where('bulan', $transaksi->bulan )->sum('total_bayar') }}" readonly>
                        </div>
                        <div class="form-group mt-1">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal" href=''>Close</button>
